...
1. Expand the row using the expandable control.
2. View the list of uploaded files.
3. Review file names and sizes.
...
3. Expand relevant document group.
4. Download required file.

### Workflow B: Find Recently Updated Documents
1. Open Filters.
2. Set Latest After date.
3. Apply filters and review Latest Release column.
4. Expand and download files.

### Workflow C: Verify Whether Files Exist in a Group
1. Locate document group in table.
2. Expand row.
...
- Adjust Latest After/Before range.

### Case B: Group Expands but No Files Appear
- The group may currently have no uploaded files.
- Confirm the No files uploaded. status message.

### Case C: Download Does Not Start
- Check browser popup or download blocking settings.
- Retry download action.
- Try another supported browser.

### Case D: Unexpected Old/New Results
...
- Applied filters and keyword
- File name (if download issue)
- Screenshot and browser/device details
