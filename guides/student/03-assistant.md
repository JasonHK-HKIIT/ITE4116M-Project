...
![Assistant page overview](./images/03-assistant-overview.png)

## 3.5 Start a New Chat
...
![New chat state](./images/03-assistant-new-chat.png)

## 3.6 Continue an Existing Chat Thread
...
![Chat history and thread](./images/03-assistant-thread-history.png)

## 3.7 Ask Effective Questions
...
![Delete thread action](./images/03-assistant-delete-thread.png)

## 3.10 Return to Portal
...
## 3.12 Privacy and Safe Use Notes
