...
Main UI components:
- Page title: News and Announcement
- Search input (desktop middle area)
- Filters button
- Filter drawer
- Article card grid
...
How to use:
1. Enter keyword(s) in the search field.
...
To open an article:
1. Select a news card.
2. System navigates to News View page.
...
3. Open top cards (latest published items).
4. Read details and return to list.

### Workflow B: Find Announcement by Date Range
1. Open Filters.
2. Set Published After and Published Before dates.
3. Apply and review result cards.
4. Open matching articles.

### Workflow C: Search by Topic
1. Enter topic keyword in search.
...
### Case B: Cannot Find Expected Announcement
- Verify keyword spelling.
- Check alternative keywords.
- Search without date filters.

### Case C: Image Not Displayed
- Refresh page.
- Retry with stable network.
- Open another article to compare behavior.
...
- Search/filter settings used
- Article title or expected date range
