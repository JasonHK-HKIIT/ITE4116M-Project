...
3. Open recent cards and review detail content.

### Workflow B: Locate Article in Time Window
1. Open Filters drawer.
2. Set Published After and Published Before.
3. Review filtered cards.
4. Open relevant items.

### Workflow C: Validate Published Communication by Topic
...
- Verify the item is published in the portal scope.

### Case B: Broken or Missing Cover Image
- Refresh and retry.
- Confirm network condition.
- Escalate with article title and screenshot.

### Case C: Navigation Back to List Lost Context
...
- Search keywords and filter dates used
- Expected article title/date
- Screenshot, browser, and OS details
